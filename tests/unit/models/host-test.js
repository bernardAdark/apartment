...
test('firstName should be required', function() {
  let model = this.subject();
  Ember.run(function() {
    model.set('firstName', '');
  });

  equal(model.get('isValid'), false, 'Host is valid without a first name');
});

test('lastName should be required', function() {
  let model = this.subject();
  Ember.run(function() {
    model.set('lastName', '');
  });

  equal(model.get('isValid'), false, 'Host is valid without a last name');
});

test('marital status should be required', function() {
  let model = this.subject();
  Ember.run(function() {
    model.set('married', '');
  });

  equal(model.get('isValid'), false, 'Host is valid without a marital status');
});

test('should be either married or not', function() {
  let model = this.subject();
  Ember.run(function() {
    model.set('married', null);
  })

  equal(model.get('isValid'), false, 'Host is valid with unknown marital status');
});

test('phone numbers should be required', function() {
  let model = this.subject();
  Ember.run(function() {
    model.set('phoneNumbers', []);
  });

  equal(model.get('isValid'), false, 'Host is valid without any phone numbers');
})

test('photo should be required', function() {
  let model = this.subject();
  Ember.run(function() {
    model.set('photo', '');
  });

  equal(model.get('isValid'), false, 'Host is valid without a photo');
});

test('photo should be base64-encoded JPEG', function() {
  let model = this.subject();
  ...
  equal(model.get('isValid'), false, 'Host is valid with a non-JPEG image');
});
